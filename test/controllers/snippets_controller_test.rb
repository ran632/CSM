...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { code: @snippet.code, privacy: @snippet.privacy, syntax: @snippet.syntax, title: @snippet.title, user_id: @snippet.user_id }
    end
  ...
  test "should update snippet" do
    patch :update, id: @snippet, snippet: { code: @snippet.code, privacy: @snippet.privacy, syntax: @snippet.syntax, title: @snippet.title, user_id: @snippet.user_id }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
